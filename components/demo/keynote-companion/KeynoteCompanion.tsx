...
import { useAgent, useUser, useAppMode } from '@/lib/state';
...
export default function KeynoteCompanion() {
  ...
  const { mode, targetLanguage } = useAppMode();
  ...
  useEffect(() => {
    setConfig({
      ...
      systemInstruction: {
        parts: [
          {
            text: createSystemInstructions(current, user, mode, targetLanguage),
          },
        ],
      },
    });
  }, [setConfig, user, current, mode, targetLanguage]);
